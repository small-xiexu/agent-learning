...
- `framework-llm-autoconfigure/src/main/java/com/xbk/agent/framework/llm/autoconfigure/ProviderAdapterRegistry.java`
...
- `framework-llm-autoconfigure/src/test/java/com/xbk/agent/framework/llm/autoconfigure/ProviderAdapterRegistryTest.java`
...
- Create: `framework-llm-autoconfigure/src/main/java/com/xbk/agent/framework/llm/autoconfigure/ProviderAdapterRegistry.java`
- Create: `framework-llm-autoconfigure/src/test/java/com/xbk/agent/framework/llm/autoconfigure/ProviderAdapterRegistryTest.java`

- [ ] **Step 1: 先写 `ProviderAdapterRegistryTest`**
...
- [ ] **Step 4: 实现 `ProviderAdapterRegistry`**

以 Spring Bean 列表作为输入，不写死枚举和 `switch` 路由。

- [ ] **Step 5: 运行 `framework-llm-autoconfigure` 单测**

Run: `/Users/sxie/maven/apache-maven-3.6.3/bin/mvn -q -pl framework-llm-autoconfigure -am -Dmaven.repo.local=/Users/sxie/xbk/agent-learning/.m2/repository -Dtest=ProviderAdapterRegistryTest -Dsurefire.failIfNoSpecifiedTests=false test`

Expected: `ProviderAdapterRegistryTest` PASS。
