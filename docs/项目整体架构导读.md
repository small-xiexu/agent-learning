...
- [module-multi-agent-roleplay README](../module-multi-agent-roleplay/README.md)
...
| `module-multi-agent-roleplay` | 更关心角色互补和流水线接力 | Sequential 角色协作 |
