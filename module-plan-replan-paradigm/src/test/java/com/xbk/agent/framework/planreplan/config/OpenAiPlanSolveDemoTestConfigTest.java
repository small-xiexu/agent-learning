...
/**
 * OpenAI Plan-and-Solve Demo 配置装载测试
 *
 * 职责：验证统一 llm 配置下，最小自动配置可以为 Plan-and-Solve Demo 提供 AgentLlmGateway 与 ChatModel Bean
 *
 * @author xiexu
 */
class OpenAiPlanSolveDemoTestConfigTest {
